...
Data *atribuirData(Data *d, unsigned int dia, unsigned int mes, unsigned int ano)
{
...
char *imprimeData(Data d, char *formato)
{
    ...
    else if (formato[0] == 'D' && formato[1] == 'D' && formato[2] == 'M' && formato[3] == 'M')
    { // DDMM
        sprintf(formato, "%u/%u", d.dia, d.mes);
    }
    else if (formato[0] == 'D' && formato[1] == 'D')
    { // DD
    ...
    else if (formato[0] == 'A' && formato[1] == 'A' && formato[2] == 'A' && formato[3] == 'A')
    { // AAAA
